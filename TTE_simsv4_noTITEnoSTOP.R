...
for(eff.pattern in 1){
  for(eff in 1:4){
    for(tox in 1:5){
      assign(paste(c("comparison_combo2v4noTITEnoSTOP_cyc3_eff",eff,".",eff.pattern,"_tox",tox),collapse=""),
      ...
      save.image(paste(c("Comparison_combo_cycles_TTE_v4_noTITEnoSTOP.RData"),collapse=""))
    }
  }
}
